...
input_frame = Frame(win, width=312, height=50, bd=0, highlightbackground="pink", highlightcolor="pink", highlightthickness=2)
input_frame.pack(side=TOP)
input_field = Entry(input_frame, font=("comic-sans", 25, "bold"),textvariable=input_text, width=50, bg="lightpink", bd=0, justify=RIGHT)
input_field.grid(row=0, column=0)
input_field.pack(ipady=10)
btns_frame = Frame(win, width=312, height=272.5, bg="lightpink")
btns_frame.pack()
